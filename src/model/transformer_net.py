"""
transformer network is a standard resnet structure
direct reference: https://github.com/pytorch/examples/blob/master/fast_neural_style/neural_style/transformer_net.py
"""
import torch
...
class TransformerNet(torch.nn.Module):
    def __init__(self):
        ...
        self.in1 = torch.nn.InstanceNorm2d(32, affine = True) # affine=True: enable learnable params
...
class ConvLayer(torch.nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride):
        ...
        # same padding if kernel_size is odd
...
class UpsampleConvLayer(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, upsample=None):
        ...
        # same padding if kernel_size = odd
        reflection_padding = kernel_size // 2
        self.reflection_pad = torch.nn.ReflectionPad2d(reflection_padding)
        self.conv2d = torch.nn.Conv2d(in_channels, out_channels, kernel_size, stride)
